...
plot4 <- function() {
     ...
     # Open the png file as a device, plot the graphs there, and close it...
     png(filename = "plot4.png", width = 480, height = 480, units = "px")
     par(mfcol = c(2,2)) # two-by-two, columns first
     ...
     # second plot...
     with(hhData, plot(DateTime, Sub_metering_1, type = "l", 
               col="black", main = "", xlab = "", 
